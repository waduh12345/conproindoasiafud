...
const translations: Translations = {
  pl: {
    ...
    brandDescription:
      "Odkryj autentyczne smaki Azji w IndoAsiaFood. Oferujemy najświeższe produkty z Indonezji, Korei, Japonii, Tajlandii i wielu innych krajów azjatyckich.",
    ...
    productLinksItems: [
      { name: "Produkty Indonezyjskie", href: "#" },
      { name: "Przyprawy Azjatyckie", href: "#" },
      { name: "Makaron i Ryż", href: "#" },
      { name: "Słodycze i Snacki", href: "#" },
      { name: "Produkty Mrożone", href: "#" },
    ],
    contactUs: "Kontakt",
  ...
  en: {
    ...
    brandDescription:
      "Discover authentic flavors of Asia at IndoAsiaFood. We offer the freshest products from Indonesia, Korea, Japan, Thailand and many other Asian countries.",
    ...
    productLinksItems: [
      { name: "Indonesian Products", href: "#" },
      { name: "Asian Spices", href: "#" },
      { name: "Noodles & Rice", href: "#" },
      { name: "Sweets & Snacks", href: "#" },
      { name: "Frozen Products", href: "#" },
    ],
    contactUs: "Contact",
