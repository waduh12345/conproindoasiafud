    ...
    <div className="fixed bottom-20 right-6 z-40">
      ...
      >
        ...
        <button
          ...
          className="relative bg-green-500 hover:bg-green-600 text-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 group"
        ...
        >
          ...
          <div className="absolute -top-1 -right-1 w-4 h-4 bg-green-400 rounded-full border-2 border-white">
            <div className="w-2 h-2 bg-green-500 rounded-full mx-auto mt-0.5 animate-pulse"></div>
          </div>
        </button>
      </div>
    </div>
